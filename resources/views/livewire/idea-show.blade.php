                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        @if ($hasVoted)
                            <button
                                ...
                                class="w-20 bg-blue text-white border border-blue font-bold text-xxs uppercase rounded-full hover:blue-hover transition duration-150 ease-in px-4 py-3 -mx-8">
                                Voted
                            </button>
                        @else
                            <button
